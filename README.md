...
<table style="width: 100%; border-spacing: 10px;">
  <tr>
    <td align="center" width="33%" style="background-color: #f9f9f9; padding: 15px; border-radius: 10px;">
      <b>Resolução de Problemas</b><br>Decomposição de desafios complexos em soluções simples e eficientes.
    </td>
    <td align="center" width="33%" style="background-color: #f9f9f9; padding: 15px; border-radius: 10px;">
      <b>Pensamento Estruturado</b><br>Foco em Clean Architecture, SOLID e padrões de projeto.
    </td>
    <td align="center" width="33%" style="background-color: #f9f9f9; padding: 15px; border-radius: 10px;">
      <b>Aprendizado Contínuo</b><br>Evolução constante através de novos estudos e experimentação.
    </td>
  </tr>
</table>
